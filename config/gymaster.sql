...
INSERT INTO `USER` (USER_FNAME, USER_LNAME, USERNAME, PASSWORD, USER_TYPE, IS_ACTIVE) VALUES
...
INSERT INTO PROGRAM (PROGRAM_NAME, IS_ACTIVE) VALUES
('Strength Training', 1),
('Cardio', 1),
('Yoga', 1),
('CrossFit', 1);
...
INSERT INTO SUBSCRIPTION (SUB_NAME, DURATION, PRICE, IS_ACTIVE) VALUES
...
-- Insert initial comorbidities
INSERT INTO COMORBIDITIES (COMOR_NAME, IS_ACTIVE) VALUES
('Hypertension', 1),
('Diabetes', 1),
('Heart Disease', 1),
('Asthma', 1),
...
INSERT INTO PAYMENT (PAY_METHOD, IS_ACTIVE) VALUES
('Cash', 1),
('Credit Card', 1),
('Debit Card', 1),
('Online Banking', 1),
